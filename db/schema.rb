...
ActiveRecord::Schema.define(version: 20140119191005) do
  ...
  create_table "competitions", force: true do |t|
    ...
    t.foreign_key ["team_id"], "teams", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_competitions_team_id"
  end
  ...
  create_table "users", force: true do |t|
    ...
    t.foreign_key ["team_id"], "teams", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_users_team_id"
  end
  ...
  create_table "adjudicators", force: true do |t|
    ...
    t.foreign_key ["competition_id"], "competitions", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_adjudicators_competition_id"
    t.foreign_key ["user_id"], "users", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_adjudicators_user_id"
  end
  ...
  create_table "events", force: true do |t|
    ...
    t.foreign_key ["competition_id"], "competitions", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_events_competition_id"
  ...
  create_table "sub_events", force: true do |t|
    ...
    t.foreign_key ["dance_id"], "dances", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_sub_events_dance_id"
    t.foreign_key ["event_id"], "events", ["id"], :on_update => :no_action, :on_delete => :no_action, :name => "fk_sub_events_event_id"
  end
