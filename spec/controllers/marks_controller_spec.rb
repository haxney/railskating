...
describe MarksController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mark" do
        ...
        put :update, :id => mark.id, :mark => {'these' => 'params'}
      end

      it "assigns the requested mark as @mark" do
        mark = Mark.create! valid_attributes
        put :update, :id => mark.id, :mark => valid_attributes
        assigns(:mark).should eq(mark)
      end
    ...
    describe "with invalid params" do
      it "assigns the mark as @mark" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mark.any_instance.stub(:save).and_return(false)
        put :update, :id => mark.id.to_s, :mark => {}
        assigns(:mark).should eq(mark)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested mark" do
      mark = Mark.create! valid_attributes
      expect {
        delete :destroy, :id => mark.id.to_s
      }.to change(Mark, :count).by(-1)
    end
